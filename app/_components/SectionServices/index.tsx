  ...
  return (
    <div className="flex w-full flex-row flex-wrap px-4 py-10 text-white md:px-40">
        ...
        >
          {Services.map(({ label, icon }) => (
            ...
            >
              {getIcon(icon)}
              <div
                className={`text-oxanium ml-2 text-lg font-bold uppercase leading-[1.2em]`}
              >
                {label}
              </div>
            </li>
      ...
      {isDetailVisible && (
        ...
        >
          <h2
            className={`heading-text fade-in text-oxanium mb-4 text-4xl font-bold uppercase leading-none lg:text-5xl`}
          >
            {activeService}
          </h2>
          <p
            className={`primary-text fade-in text-oxanium text-xl text-gray-400`}
          >
