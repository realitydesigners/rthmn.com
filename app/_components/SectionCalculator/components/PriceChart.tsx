...
export const PriceChart = memo(({ entryPrice, stopLoss, takeProfit, direction }: PriceChartProps) => {
            ...
            <div className='relative h-full'>
                ...
                <div className='absolute bottom-4 left-4'>
                    <div className='rounded-full bg-white/5 px-3 py-1'>
                        <span className='font-kodemono text-sm text-white/60'>Risk/Reward: 1:{ratio.toFixed(2)}</span>
                    </div>
                </div>
            </div>
        </div>
