...
import { FaChartLine, FaPercentage, FaDollarSign, FaExchangeAlt } from 'react-icons/fa';
...
export const TradeStats = memo(({ entryPrice, stopLoss, takeProfit, positionSize, riskAmount, potentialProfit }: TradeStatsProps) => {
