...
import { client, sanityFetch } from '@/utils/sanity/lib/client';
import { queryNewsArticle, queryPortfolioItem, querySlugPageData, querySlugPagePaths } from '@/utils/sanity/lib/query';
import { getMetaData } from '@/utils/sanity/lib/seo';
