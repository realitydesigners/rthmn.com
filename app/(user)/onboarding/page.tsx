		...
		<div className="relative min-h-screen bg-black">
			...
			>
				<motion.div
					...
					className={`relative w-full rounded-2xl border border-[#222] bg-gradient-to-b from-[#0A0B0D] to-[#070809] p-8 shadow-2xl before:pointer-events-none before:absolute before:inset-0 before:rounded-2xl before:bg-[radial-gradient(circle_at_50%_-20%,rgba(255,255,255,0.05),rgba(255,255,255,0))]`}
				>
					{/* Progress indicator */}
