		...
		<div className="relative min-h-screen bg-black">
			...
			>
				<motion.div
					...
					className={`relative w-full rounded-2xl border border-[#111215] bg-gradient-to-b from-[#0A0B0D] to-[#070809] p-8 shadow-2xl before:pointer-events-none before:absolute before:inset-0 before:rounded-2xl before:bg-[radial-gradient(circle_at_50%_-20%,rgba(255,255,255,0.05),rgba(255,255,255,0))]`}
				>
					{/* Progress indicator */}
					<div className="no-select absolute -top-3 left-1/2 -translate-x-1/2">
						<div className="flex items-center gap-2 rounded-full border border-[#1C1E23]  bg-gradient-to-b from-[#0A0B0D] to-[#070809] px-4 py-1.5 text-xs font-medium shadow-xl">
							<div className="flex h-1.5 w-12 items-center rounded-full bg-[#111215]">
								<motion.div
