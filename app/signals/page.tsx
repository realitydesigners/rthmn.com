  ...
  function SubscriptionPrompt() {
    return (
      <div className="text-center mt-10">
        ...
        <Link href="/subscribe" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
          Get Subscription
        </Link>
      </div>
    )
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full bg-black shadow-lg rounded-lg text-xs">
                <thead className="bg-black">
                  <tr>
                    <th className="px-3 py-2 text-left text-[10px] font-bold text-gray-300 uppercase tracking-wider">Pair</th>
                    <th className="px-3 py-2 text-left text-[10px] font-bold text-gray-300 uppercase tracking-wider">Pattern Type</th>
                    <th className="px-3 py-2 text-left text-[10px] font-bold text-gray-300 uppercase tracking-wider">Pattern</th>
                    <th className="px-3 py-2 text-left text-[10px] font-bold text-gray-300 uppercase tracking-wider">Status</th>
                    <th className="px-3 py-2 text-left text-[10px] font-bold text-gray-300 uppercase tracking-wider">Start Price</th>
                    <th className="px-3 py-2 text-left text-[10px] font-bold text-gray-300 uppercase tracking-wider">End Price</th>
                    <th className="px-3 py-2 text-left text-[10px] font-bold text-gray-300 uppercase tracking-wider">Stop Loss</th>
                    <th className="px-3 py-2 text-left text-[10px] font-bold text-gray-300 uppercase tracking-wider">Take Profit</th>
                    <th className="px-3 py-2 text-left text-[10px] font-bold text-gray-300 uppercase tracking-wider">Start Time</th>
                    <th className="px-3 py-2 text-left text-[10px] font-bold text-gray-300 uppercase tracking-wider">End Time</th>
                    <th className="px-3 py-2 text-left text-[10px] font-bold text-gray-300 uppercase tracking-wider">Created At</th>
                  </tr>
                </thead>
                  ...
                  {signalsData.map((signal: Signal) => {
                    ...
                    return (
                      <tr key={signal.id} className="hover:bg-[#181818]">
                        ...
                        <td className="px-3 py-2 whitespace-nowrap text-gray-300">{signal.start_time ? new Date(signal.start_time).toLocaleString() : 'N/A'}</td>
                        <td className="px-3 py-2 whitespace-nowrap text-gray-300">{signal.end_time ? new Date(signal.end_time).toLocaleString() : 'N/A'}</td>
