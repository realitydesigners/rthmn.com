...
import { FaArrowLeft, FaArrowRight, FaBookmark, FaCheckCircle, FaClock } from 'react-icons/fa';
...
export default function LessonClient({ course, lesson, chapter }: LessonClientProps) {
    ...
    }, [course._id, chapter._id, lesson._id, store.completeLesson]);

    const handleUncomplete = useCallback(() => {
        store.uncompleteLesson(course._id, chapter._id, lesson._id);
    }, [course._id, chapter._id, lesson._id, store.uncompleteLesson]);
