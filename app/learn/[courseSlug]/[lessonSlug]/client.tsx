...
import { FaArrowLeft, FaArrowRight, FaBookmark, FaCheckCircle, FaClock, FaPlay } from 'react-icons/fa';
                        ...
                        >
                            <div className='flex items-center gap-4'>
                                ...
                                <div className='flex-1 min-w-0'>
                                    ...
                                    <p className='mt-1 text-xs text-white/60'>{course.description}</p>
                                </div>
                            </div>
...
export default function LessonClient({ course, lesson, chapter }: LessonClientProps) {
    ...
    const currentLessonIndex = chapter.lessons.findIndex((l: any) => l._id === lesson._id);
