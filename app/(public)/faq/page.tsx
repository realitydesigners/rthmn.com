            ...
            <div className='grid gap-6 md:grid-cols-3'>
                {[
                    ...
                    <Link
                        ...
                        <div className={`mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br ${item.color} p-3 text-white shadow-lg`}>{item.icon}</div>
                        <h3 className='font-outfit mb-2 text-xl font-semibold text-white'>{item.title}</h3>
                        <p className='font-kodemono mb-4 text-sm text-gray-400'>{item.description}</p>
