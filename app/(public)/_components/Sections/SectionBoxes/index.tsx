...
import { BASE_VALUES, createDemoStep, createMockBoxData, sequences } from '@/app/(public)/_components/constants/constants';
import { FEATURE_TAGS } from '@/app/(public)/_components/constants/text';
import { NestedBoxes } from '@/app/(public)/_components/NestedBoxes';
...
const StaticContent = memo(() => (
    <div className='flex flex-col justify-center'>
        ...
        <p className='font-kodemono mb-8 text-base leading-relaxed text-gray-400 sm:mb-12 sm:text-lg'>Discover hidden market patterns through advanced mathematics.</p>
        <FeatureTags />
    </div>
));
