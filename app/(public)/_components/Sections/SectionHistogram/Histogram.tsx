...
import { getAnimationSequence } from '@/app/(public)/_components/constants/constants';
...
export const Histogram: React.FC<HistoricalPatternViewProps> = ({ tableRef, demoStep, patterns, dimensions }) => {
    ...
    return (
        <div
            className='font-kodemonoborder-gray flex w-full items-center justify-center overflow-hidden rounded-lg'
            style={{
                        ...
                        return (
                            <div
                                ...
                                className={`relative shrink-0 transition-all duration-300 ${
                                    isCurrentPattern ? 'scale-105 opacity-100' : 'scale-100 opacity-70'
