            ...
            <div
                ...
                <button onClick={onClick} className='flex w-full cursor-pointer items-center justify-between p-6'>
                    ...
                    <motion.div
                        ...
                        className={`transition-colors duration-300 ${isActive ? 'text-emerald-400' : 'text-gray-400 group-hover:text-gray-400'}`}>
                    ...
                    <div className='border-t border-white/5 px-6 py-6'>
                        ...
                        {item.category && (
                            <div className='mt-4 flex items-center gap-2'>
                                <span className='rounded-full bg-white/5 px-3 py-1 text-xs text-gray-400'>{item.category}</span>
                            </div>
                        )}
                    </div>
                </motion.div>
        ...
        <section className='relative min-h-screen overflow-hidden py-32'>
            <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
                <motion.div
                    ...
                    <h2 className='text-gray-gradient font-outfit mb-6 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl'>{title}</h2>
