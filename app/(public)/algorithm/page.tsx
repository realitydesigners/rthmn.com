...
const CORE_CONCEPTS = [
    ...
    {
        title: 'Pattern Recognition',
        description: 'Identifying recurring market structures through rhythmic state analysis and wave mechanics.',
        icon: FaChartLine,
    },
];
            ...
            <section className='py-20'>
                <div className='mx-auto max-w-7xl px-8'>
                    <div className='grid grid-cols-1 gap-12 lg:grid-cols-2'>
                        ...
                        <div className='space-y-8'>
                            <h2 className={`font-outfit text-3xl font-bold text-white`}>Core Concepts</h2>
                        ...
                        {[
                            {
                                ...
                                description: 'Precise identification of market positions across all timeframes',
                            },
                            {
                                metric: '< 0.5ms',
                                label: 'Processing Time',
                                description: 'Ultra-fast pattern recognition and position state analysis',
                            },
                            {
                                metric: '8D',
                                label: 'Analysis Depth',
                                description: 'Eight-dimensional market structure analysis for complete coverage',
                            },
                        ].map((item, index) => (
                            <motion.div
                                key={index}
            ...
            <section className='relative py-32'>
                ...
                <div className='mx-auto max-w-7xl px-8'>
                    ...
                    <div className='mt-24 space-y-16'>
                        ...
                        <div className='space-y-12'>
                            <h3 className={`font-outfit text-3xl font-semibold text-white/90`}>How It Works</h3>
