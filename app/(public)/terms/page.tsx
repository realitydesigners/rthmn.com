  ...
  return (
    <div className="min-h-screen pt-24">
      <div className="container mx-auto px-4 md:px-8">
        <h1
          className={`my-12 text-center font-russo text-4xl text-white lg:text-5xl`}
        >
          Terms of Service
        </h1>
        <div className="relative mx-auto max-w-4xl">
          <div className="prose prose-invert max-w-none">
            <div className="mb-8 rounded-lg border border-gray-900 bg-gray-900/25 p-4 lg:p-8">
              <h2 className={`mb-6 font-outfit text-2xl font-bold text-white`}>
                1. Acceptance of Terms
              </h2>
              <p className={`mb-6 font-outfit text-gray-400`}>
