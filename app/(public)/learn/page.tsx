    ...
    return (
        <div className='bg-background min-h-screen'>
            <div className='container mx-auto px-4 py-16'>
                ...
                <p className='text-muted-foreground mb-12'>Explore Rthmn and forex trading.</p>

                <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3'>
                    {modules?.map((module: Module) => (
                        <div key={module._id} className='bg-card border-border rounded-lg border p-6'>
                            <h2 className='mb-4 text-2xl font-semibold'>{module.title}</h2>
                            {module.description && <p className='text-muted-foreground mb-6'>{module.description}</p>}
