...
export const NavigationDots: React.FC<NavigationDotsProps> = ({ currentSection, onButtonClick }) => {
                    ...
                    <button
                        ...
                        <div
                            className={`relative h-3 w-3 rounded-full transition-all duration-300 ${
                                currentSection === button.sectionId ? 'bg-gradient-to-r from-blue-500 to-blue-400 shadow-lg shadow-blue-500/50' : 'bg-gray-600 hover:bg-gray-500'
