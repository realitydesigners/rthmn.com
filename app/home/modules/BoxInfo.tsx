...
const FEATURES = [
    ...
    },
    {
        ...
        description: 'Prices move up and down, but the market is always in one state or another',
    },
    {
        icon: FaChartLine,
        title: 'Pattern Recognition',
        description: 'Visualize complex market patterns through geometric relationships',
    },
    {
        icon: FaBrain,
        ...
        <motion.div
            ...
            <div className='space-y-8'>
                ...
                <div className='space-y-4'>
                    ...
                    <p className='text-dark-gray font-kodemono w-11/12 text-lg lg:text-xl'>The universal pattern recognition toolkit designed for trading.</p>
