      ...
      <ul className="space-y-1">
        {Object.entries(pairs).map(([pair, data]) => (
          <li
            ...
            } ${selectedPair === pair ? 'overflow-hidden border border-[#222]' : ''}`}
          >
            <div
              className={`flex items-center justify-between py-2 hover:bg-[#111] ${selectedPair === pair ? 'border-b border-[#222]' : ''}`}
            >
              <button
