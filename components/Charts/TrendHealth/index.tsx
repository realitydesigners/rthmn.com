...
export const TrendHealth: React.FC<EmotionGaugeProps> = ({ trendData }) => {
  const { positiveCount, negativeCount, totalCount, positivePercentage } =
    useMemo(() => {
  ...
  return (
    <div
      className="rounded-lg bg-black p-4 shadow-lg"
      style={{
    ...
    >
      <div
        ...
        style={{ color: COLORS.NEUTRAL.LIGHT }}
      >
        <span
          style={{
      ...
      >
        ...
        <span>
          {negativeCount}/{totalCount} negative
        </span>
      </div>
      <div
