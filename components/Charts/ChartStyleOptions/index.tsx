            ...
            className={cn(
                ...
                isActive
                    ? [
                          ...
                          'hover:border-white/[0.05] hover:shadow-[0_4px_8px_0_rgba(0,0,0,0.5)]',
                      ]
                    : [
        ...
        >
            ...
            >
                ...
                <Icon
                    ...
                    className={cn(
                        ...
                        isActive ? 'text-[#888] group-hover:text-white' : 'text-[#666] group-hover:text-[#888]',
                        locked ? 'text-[#666] opacity-40' : 'group-hover:scale-105'
                    )}
                />
            </div>
            ...
            <span
                className={cn(
                    ...
                    locked ? 'text-[#666]/40' : isActive ? 'text-[#888]' : 'text-[#666] group-hover:text-[#888]'
                )}
            >
                {title}
            </span>
...
export const ChartStyleOptions: React.FC<ChartStyleOptionsContainerProps> = ({
    ...
    return (
        <div
            className={cn(
                'flex gap-4 rounded-lg border border-white/[0.02] bg-gradient-to-b from-[#0A0B0D] to-[#070809] p-4 shadow-[0_2px_4px_0_rgba(0,0,0,0.4)]',
                className
            )}
        >
            {content}
