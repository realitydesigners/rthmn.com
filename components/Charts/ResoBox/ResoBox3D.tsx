...
export const ResoBox3D = memo(
  ({
        ...
        if (index === 0) {
          ...
          if (prevSortedBoxData) {
            ...
            const magnitude = Math.sqrt(
              offsetVector[0] ** 2 + offsetVector[1] ** 2 + offsetVector[2] ** 2
            );
    ...
    return (
      <div ref={containerRef} {...props(styles.container)}>
        <Canvas
        ...
        >
          ...
          <group>
            ...
            {sortedBoxes.map((box) => {
              const data = calculatedPositionsAndDimensions.get(
                box.originalIndex
              );
              if (!data) return null;
