import type { BoxSlice, BoxColors } from "@/types/types";
...
export const PriceAxis: React.FC<PriceAxisProps> = ({ slice, pair, boxColors }) => {
  // Guard
  ...
  const ticks = [
    ...
    { price: lowest, color: boxColors.negative.replace("#", "#") || "rgba(255,255,255,0.5)" },
  ];
