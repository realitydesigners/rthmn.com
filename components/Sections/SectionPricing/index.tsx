        ...
        <section className='relative min-h-screen overflow-hidden py-32'>
            ...
            <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className='mx-auto max-w-2xl'>
                    <div className='inset-shadow-sm inset-shadow-white/5 relative overflow-hidden rounded-xl border border-white/10 bg-black/40 shadow-xl shadow-black/20 backdrop-blur-sm'>
                        ...
                        <div className='p-8'>
                            ...
                            <div className='mb-8 text-center'>
                                ...
                                <div className='mb-4'>
                                    <div className='inline-flexrounded-full inset-shadow-xs px-6 py-2 shadow-lg'>
                            ...
                            <div className='mb-8'>
                                <div className='flex w-full flex-col items-start justify-start'>
                                    {PricingBenefits.map((benefit, index) => (
                                        <div
                                            key={index}
                                            className='hover:inset-shadow-2xs hover:inset-shadow-white/10 flex w-auto items-center gap-3 rounded-lg p-2 px-2 text-neutral-400 transition-all duration-300 hover:bg-white/5'>
                                            <div className='inset-shadow-xs inset-shadow-white/10 flex h-6 w-6 items-center justify-center rounded-full bg-white/5 shadow-sm'>
                            ...
                            <button
                                ...
                                className='bg-linear-to-b inset-shadow-sm inset-ring inset-shadow-white/10 inset-ring-white/5 group relative flex w-full items-center justify-center rounded-full from-[#333333] to-[#181818] p-[1px] text-white shadow-lg shadow-black/20 ring-1 ring-white/10 transition-all duration-300 hover:from-[#444444] hover:to-[#282828] hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-50'>
                                <span className='font-outfit bg-linear-to-b group-hover:inset-shadow-sm group-hover:inset-shadow-white/5 relative flex w-full items-center justify-center gap-2 rounded-full from-[#0A0A0A] to-[#181818] px-4 py-3 text-lg font-medium transition-all duration-300'>
            ...
            <div className='pointer-events-none absolute inset-0 overflow-hidden'>
                ...
                <div className='absolute -bottom-1/2 right-0 h-96 w-96 translate-x-1/2 rounded-full bg-white/5 blur-3xl' />
            </div>
        </section>
    );
}
