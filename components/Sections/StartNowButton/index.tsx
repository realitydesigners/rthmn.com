...
export const StartButton: FC<StartButtonProps> = ({ href, children = 'Start Now', custom = 0 }) => {
    const combinedVariants = {
        ...
        visible: {
            opacity: 1,
            y: 0,
            boxShadow: ['0 0 5px rgba(255, 255, 255, 0.1)', '0 0 15px rgba(255, 255, 255, 0.3)', '0 0 5px rgba(255, 255, 255, 0.1)'],
            transition: {
    ...
    return (
        <motion.div variants={combinedVariants} initial='hidden' animate='visible' custom={custom} whileTap={{ scale: 0.97 }} className='inline-block rounded-full'>
            <Link
                href={href}
