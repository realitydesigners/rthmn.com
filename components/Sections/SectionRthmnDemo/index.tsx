					...
					<div className="relative flex h-full w-full items-center justify-between rounded-lg px-2">
                        ...
                        {[
                            ...
                            <button
                                ...
                                className={`flex h-auto items-center rounded-full bg-linear-to-b from-[#32353C] to-[#181818] p-[1px] text-white transition-all duration-200 hover:from-[#32353C] hover:to-[#282828]`}>
                                <span
