    ...
    return (
        <section className='relative overflow-hidden pt-60'>
            <div className='pointer-events-none absolute inset-0'>
                ...
                <div className='absolute right-1/4 top-1/4 h-[500px] w-[500px] bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.03),transparent_70%)] blur-3xl' />
            </div>
            ...
            <div className='relative flex w-full flex-col gap-8'>
                <motion.div
                    ...
                    <h1 className={`text-neutral-gradient font-outfit relative z-10 text-[3em] font-bold leading-[1em] tracking-tight lg:text-[8em] lg:leading-[1em]`}>
                        Unlock Market
                        <br />
                        Patterns, Instantly.
                    </h1>
