...
const MARKETS = [
    {
        ...
        icon: FaChartLine,
        stats: '83% accuracy',
        description: 'Spot major currency moves before they develop. Perfect for both scalping and swing trading.',
    ...
    },
    {
        ...
        description: 'Navigate crypto volatility with confidence. Stay on the right side of major moves.',
