...
const histogramBenefits = [
	{
		...
		description:
			"Instantly see high-volume nodes acting as crucial support and resistance zones.",
	},
	{
		icon: FaSignal,
		title: "Gauge Market Strength",
		description:
			"Understand where conviction lies by visualizing volume concentration at specific price points.",
	},
	{
		icon: FaCrosshairs,
		title: "Spot Activity Hotspots",
		description:
			"Identify price levels with the most trading activity, revealing areas of high interest.",
	},
];
