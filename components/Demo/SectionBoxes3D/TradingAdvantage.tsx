...
export const TradingAdvantage = memo(() => {
	return (
		<section className="relative min-h-screen w-full bg-gradient-to-b from-black via-[#0A0B0D] to-[#050506] pt-16 sm:pt-24">
				...
				<div className="max-w-7xl mx-auto space-y-12 sm:space-y-20">
					...
					>
						<h2 className="font-russo text-3xl sm:text-4xl lg:text-6xl xl:text-7xl font-black text-white tracking-tighter leading-[0.85] uppercase">
							A NEW TRADING
							<span className="block text-[#24FF66] mt-1 sm:mt-2">PARADIGM</span>
						</h2>
