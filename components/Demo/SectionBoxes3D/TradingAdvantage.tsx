    ...
    <section className="relative min-h-screen w-full pt-16 sm:pt-24">
      <div className="container mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <div className="max-w-7xl mx-auto space-y-12 sm:space-y-20">
          ...
          >
            <h2 className="font-russo text-3xl sm:text-4xl lg:text-6xl xl:text-7xl font-black text-white  leading-[0.85] uppercase">
              A NEW TRADING
          ...
          >
            <h3 className="font-russo text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-black text-white uppercase ">
