...
export const PairNavigator = () => {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div
        ref={scrollRef}
        className="flex-1 overflow-y-auto px-4 pb-20 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
      >
      ...
      <div className="absolute inset-x-0 bottom-30  pt-6">
        <div className="w-full px-4 -mb-5">
          <div className="flex w-auto overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
