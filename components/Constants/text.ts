...
export const STEPS = [
    {
        ...
        description:
            'Rthmn analyzes market data to identify recurring patterns and energy flows across different timeframes.',
    },
    {
        step: '02',
        title: 'State Classification',
        description:
            'Market movements are classified into one of eight natural states, each representing a distinct pattern of energy flow.',
    },
    {
        step: '03',
        title: 'Energy Flow Tracking',
        description:
            'The algorithm tracks how market energy transforms from one state to another, building a predictive model.',
    },
    {
        step: '04',
        title: 'Probability Mapping',
        description:
            'Based on historical patterns and current market state, Rthmn calculates the probability of future movements.',
    },
];
...
export const ALGORITHM_STEPS = [
    {
        ...
        title: 'Pattern Recognition',
        description:
            'Advanced algorithms compress market data across multiple dimensions, revealing hidden patterns and frequencies in price movement.',
    },
    {
        step: '02',
        title: 'State Analysis',
        description:
            'Continuous tracking of market states through vector mathematics identifies precise moments of positional shift and energy transfer.',
    },
    {
        step: '03',
        title: 'Fractal Mapping',
        description:
            'Self-similar patterns are mapped across timeframes, creating a comprehensive model of market structure and behavior.',
    },
    {
        step: '04',
        title: 'Frequency Detection',
        description:
            'By analyzing the frequency and amplitude of market movements, Rthmn anticipates major shifts before they occur.',
    },
];
...
export const PRACTICAL_APPLICATIONS = {
    ...
    examples: [
        ...
        },
        {
            ...
            description:
                'Know exactly when stocks are about to break out or reverse. Catch the big moves while avoiding false signals that trap most traders.',
