...
export const StartButton: FC<StartButtonProps> = ({
  ...
  return (
    ...
    >
      <Link
        href={href}
        className="flex items-center rounded-full bg-linear-to-b from-[#FFFFFF] to-[#D0D0D0]/50 p-[1.5px] font-outfit text-black transition-all duration-200 hover:from-[#F0F0F0] hover:via-[#E0E0E0] hover:to-[#C0C0C0]/50"
      >
