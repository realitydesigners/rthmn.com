...
export const StartButton: FC<StartButtonProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <span className="flex w-full items-center space-x-3 rounded-full bg-gradient-to-b from-[#FAFAFA] to-[#F0F0F0] px-6 py-3 text-lg font-bold shadow-[inset_0_2px_5px_rgba(0,0,0,0.2),inset_0_-2px_2px_rgba(0,0,0,0.2)]">
          {children}
        </span>
      </Link>
    </MotionDiv>
