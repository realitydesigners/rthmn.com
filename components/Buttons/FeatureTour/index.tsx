          ...
          className={cn(
            ...
            isCurrentTour &&
              ...
              [
                ...
                ...(isHovered
                  ? [
                      "shadow-[inset_0_0_50px_rgba(36,255,102,0.6)]",
                      "shadow-[inset_0_0_25px_rgba(36,255,102,0.5)]",
                      "inset-shadow-sm inset-shadow-[#24FF66]/50",
                      "inset-shadow-xs inset-shadow-[#24FF66]/40",
                      "bg-linear-45/oklch from-[#24FF66]/35 via-[#24FF66]/20 to-transparent",
                      "border-[#24FF66]/50",
                      "shadow-lg shadow-[#24FF66]/40",
                      "shadow-md shadow-[#24FF66]/30",
                    ]
                  : []),
              ].join(" "),
            !isCompleted &&
        ...
        >
          ...
          <Icon
            ...
            className={cn("relative z-10 transition-colors", {
              "text-[#24FF66]": isCurrentTour && !isCompleted && !isHovered,
              "text-[#1ECC52]": isCurrentTour && !isCompleted && isHovered,
              "text-[#B0B0B0]": (!isCurrentTour || isCompleted) && !isHovered,
              "text-white": (!isCurrentTour || isCompleted) && isHovered,
            })}
          />
        </button>
