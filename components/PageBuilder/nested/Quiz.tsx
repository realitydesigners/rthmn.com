	...
	return (
		<div className="flex w-full flex-col items-center justify-center">
			<motion.div
				...
				className="relative my-12 overflow-hidden rounded-2xl max-w-2xl bg-black p-0.5 before:absolute before:inset-0 before:rounded-2xl before:bg-[linear-gradient(120deg,transparent_0%,rgba(0,115,230,0)_10%,rgba(0,115,230,0.1)_45%,rgba(0,115,230,0.05)_55%,rgba(0,115,230,0.1)_80%,rgba(0,115,230,0)_90%,transparent_100%)] before:bg-[length:400%_100%] before:animate-[shimmer_12s_linear_infinite] shadow-[0_0_30px_rgba(0,115,230,0.1)] ring-1 ring-[#1C1E23]"
			>
				...
				<div className="relative rounded-2xl bg-black p-8">
					...
					<div className="absolute -top-12 -right-12 h-24 w-24 rounded-full bg-gradient-to-br from-[#1C1E23] to-transparent opacity-20 blur-2xl" />
					...
					<div className="mb-8 space-y-3">
						{options.map((option) => (
							<motion.button
								...
								onClick={() =>
									!hasSubmitted && setSelectedAnswer(options.indexOf(option))
								}
									...
									hasSubmitted
										? options.indexOf(option) === correctAnswer
											...
											: options.indexOf(option) === selectedAnswer
												...
												: "bg-black ring-1 ring-[#1C1E23]"
										: selectedAnswer === options.indexOf(option)
											? "bg-[#0073E6]/10 ring-1 ring-[#0073E6]/20"
											: "bg-black hover:bg-[#0073E6]/5 ring-1 ring-[#1C1E23]"
								}`}
												...
												hasSubmitted
													? options.indexOf(option) === correctAnswer
														...
														: options.indexOf(option) === selectedAnswer
															...
															: "bg-black/30 ring-1 ring-[#1C1E23]"
													: selectedAnswer === options.indexOf(option)
														? "bg-[#0073E6]/20 ring-1 ring-[#0073E6]/20"
														: "bg-black/30 ring-1 ring-[#1C1E23] opacity-0 group-hover:opacity-100"
											}`}
										>
											{hasSubmitted &&
												options.indexOf(option) === correctAnswer && (
								...
								<div className="p-5">
									...
									{explanation && showExplanation && (
										<motion.div
											...
											className="mt-4 flex items-start gap-3 rounded-lg bg-black/30 p-4 ring-1 ring-[#1C1E23]"
										>
