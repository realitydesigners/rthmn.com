				...
				<div className="mx-auto max-w-7xl px-8">
					...
					<div className="flex flex-col items-center text-center">
						<motion.div
							...
							className="mb-8"
						>
							<h1 className="text-neutral-gradient font-russo text-6xl font-bold tracking-tight text-transparent lg:text-7xl">
								{title}
							</h1>
								...
								>
									...
									<div className="space-y-6">
										...
										<div className="flex flex-col items-start justify-between gap-2">
											...
											<div>
												<h2 className="font-russo text-4xl font-bold text-white/90">
													{entry.title}
												</h2>
