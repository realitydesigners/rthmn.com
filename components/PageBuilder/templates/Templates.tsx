...
const headingStyles: Record<TemplateTheme, string> = {
	dark: `font-russo my-3 w-full text-white font-bold leading-none tracking-wide md:w-3/4 lg:w-1/2`,
	light: `font-russo my-3 w-11/12 text-black font-bold leading-none tracking-wide md:w-3/4 lg:w-1/2`,
};

const listStyles: Record<TemplateTheme, string> = {
	dark: `font-russo w-full text-white  leading-7 md:w-3/4 lg:w-1/2 text-xl list-decimal list-inside russo-y-6 mb-6`,
	light: `font-russo w-11/12 text-black leading-7 md:w-3/4 text-xl lg:w-1/2  list-decimal list-inside russo-y-6 mb-6`,
};

const normalTextStyles: Record<TemplateTheme, string> = {
	dark: `font-russo w-full text-white   bg-clip-text leading-[1.4em] tracking-wide text-xl md:w-3/4 lg:w-1/2 lg:text-xl`,
	light: `font-russo text-black leading-[1.5em] tracking-wide text-xl md:w-3/4 lg:w-1/2 lg:text-xl`,
};
...
const Heading: React.FC<HeadingComponentProps> = ({
	...
	const combinedClassName = `${headingStyles[theme]} ${fontSize}`.replace(
		/text-\w+/,
		"",
	);
