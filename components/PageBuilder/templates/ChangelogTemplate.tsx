...
export const ChangelogTemplate: PortableTextComponents = {
    ...
    list: {
        bullet: ({ children }) => <ul className={`mb-6 list-disc space-y-2 pl-4 font-mono text-gray-400`}>{children}</ul>,
        number: ({ children }) => <ol className={`mb-6 list-decimal space-y-2 pl-4 font-mono text-gray-400`}>{children}</ol>,
    },
    listItem: {
        bullet: ({ children }) => <li className='leading-relaxed text-gray-400'>{children}</li>,
        number: ({ children }) => <li className='leading-relaxed text-gray-400'>{children}</li>,
    },
    marks: {
