...
export const ChangelogTemplate: PortableTextComponents = {
    block: {
        ...
        h1: ({ children }) => <h1 className={`font-outfit mb-6 text-3xl font-bold leading-relaxed text-neutral-400`}>{children}</h1>,
        h2: ({ children }) => <h2 className={`font-outfit mb-4text-2xl font-bold leading-relaxed text-white`}>{children}</h2>,
        h3: ({ children }) => <h3 className={`font-outfit mb-3 text-xl font-bold leading-relaxed text-white`}>{children}</h3>,
        h4: ({ children }) => <h4 className={`font-outfit mb-2 text-lg font-bold leading-relaxed text-white`}>{children}</h4>,
    },
    list: {
