    ...
    return (
        <FeatureTour
            ...
            {({ isActive: tourActive, hasCompleted }) => (
                <button
                    onClick={onClick}
                    disabled={isOnboarding || (currentStepId && !isCurrentTour && !isCompleted)}
                    className={cn(
                        ...
                        (isOnboarding || (currentStepId && !isCurrentTour && !isCompleted)) && 'opacity-50'
                    )}>
                    <Icon
                        size={20}
                        className={cn(
                            ...
                            (isOnboarding || (currentStepId && !isCurrentTour && !isCompleted)) && 'text-white'
                        )}
                    />
                </button>
            )}
