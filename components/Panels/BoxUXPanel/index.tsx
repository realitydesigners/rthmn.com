		...
		(preset: any) => {
			updateBoxColors({
				...
				styles: {
					...
					globalTimeframeControl:
						boxColors.styles?.globalTimeframeControl ?? false,
				},
			});
		},
...
export const SettingsBar = () => {
	...
	const handleFullPresetClick = useHandlePresetClick(
		updateBoxColors,
		boxColors,
	);
