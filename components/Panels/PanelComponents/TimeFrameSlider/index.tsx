...
export const TimeFrameSlider: React.FC<PatternVisualizerProps> = memo(
    ({ startIndex, maxBoxCount, boxes, onStyleChange, onDragStart, onDragEnd }) => {
                            ...
                            case 'left': {
                                ...
                                const newMaxBoxCount = Math.max(
                                    ...
                                    Math.min(
                                        ...
                                        reversedMaxBoxCount + (previousIndex - newReversedStartIndex)
                                    )
                                );
        ...
        return (
            <div className='relative h-full px-2 pb-6'>
                ...
                <DynamicTimeScale
                    reversedStartIndex={reversedStartIndex}
                    reversedMaxBoxCount={reversedMaxBoxCount}
                ...
                <div key={`scale-mark-${i}-${timeInfo.minutes}min`} className='relative flex flex-col items-center'>
                    ...
                    <span
                        className={cn(
                            ...
                            isInRange
                                ? 'font-medium text-white/90 drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]'
                                : 'text-white/30'
                        )}
                    >
                        {timeInfo.label}
