...
export const PanelSection = ({ title, icon: Icon, isExpanded, onToggle, children, className }: PanelSectionProps) => {
    return (
            ...
            >
                <div className='flex items-center'>
                    <div className='flex h-6 w-6 items-center justify-center rounded-full bg-gradient-to-b from-[#0A0B0D] to-[#070809] shadow-xl'>
                        <Icon size={14} className='text-[#666] transition-colors group-hover:text-[#888]' />
                    </div>
