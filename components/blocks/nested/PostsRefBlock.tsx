    ...
    <div className="flex w-full items-center justify-center px-4 py-4">
      <div className="group flex h-auto w-full flex-row rounded-lg bg-linear-to-r from-blue-200/10 to-blue-200/5 p-3 shadow-lg transition-shadow duration-300 hover:shadow-xl md:w-1/3 lg:w-1/3">
        ...
        <div className="relative flex w-3/4 flex-col pl-4">
          <p className="mb-2 bg-linear-to-r from-blue-100/50 to-blue-100/50 bg-clip-text pt-2 text-xs uppercase leading-none tracking-wide text-transparent">
            Related Post
          </p>

          <Link
            className="duration-3 bg-linear-to-r from-blue-100/100 to-blue-100/90 bg-clip-text text-2xl font-bold leading-[1.2em] text-transparent transition-colors group-hover:text-gray-100 group-hover:underline"
            href={`/posts/${slug}`}
          >
            {heading}
          </Link>
