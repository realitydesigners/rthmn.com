...
export async function SignalProvider({ children }: { children: React.ReactNode }) {
    const { signalsData } = await fetchSignalsServer();

    return <SignalProviderClient initialSignalsData={signalsData}>{children}</SignalProviderClient>;
}
