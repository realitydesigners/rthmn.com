import { ClipboardIcon, DashboardIcon, DatabaseIcon, MasterDetailIcon, UserIcon } from '@sanity/icons';
    ...
    return (
        <div draggable='true' onDragStart={handleDragStart} style={containerStyle}>
            <div style={{ display: 'flex', width: '100%', alignItems: 'center' }}>
                ...
                <div style={{ width: '90%', height: '100%' }}>{renderDefault({ value, ...restProps })}</div>
            </div>
        </div>
    );
}
